...
public class UserController extends BaseController {
    ...
    public Resp<Result> login(@RequestParam(value = "userName") String userName,
        ...
        if (StringUtils.isEmpty(ip)) {
            return Resp.fail("IP_IS_EMPTY.getCode(), IP_IS_EMPTY.getMsg()");
        }

        // verify username and password
        Result<Map<String, String>> result = passwordAuthenticator.authenticate(userName, userPassword, ip);
