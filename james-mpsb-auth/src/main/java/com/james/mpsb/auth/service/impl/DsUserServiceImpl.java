 ...
 */
@Service("userService")
public class DsUserServiceImpl extends ServiceImpl<DsUserMapper, DsUser> implements IDsUserService {

    @Override
    public PageVo queryPage(QueryCondition params) {
        IPage<DsUser> page = this.page(
                new Query<DsUser>().getPage(params),
                new QueryWrapper<>()
        );
